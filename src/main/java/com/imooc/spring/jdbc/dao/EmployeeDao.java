...
public class EmployeeDao {
    ...
    public void insert(Employee employee){
        String sql="insert into employee(eno,dname,ename,hiredate,salary) values(?,?,?,?,?)";
        jdbcTemplate.update(sql,new Object[]{
                employee.getEno(),employee.getDname(),employee.getEname(),employee.getHiredate(),employee.getSalary()
        });
    }

    public int update(Employee employee){
        String sql="UPDATE employee SET salary=?,dname=?,ename=?,hiredate=? WHERE eno=?";
        int count=jdbcTemplate.update(sql,new Object[]{
                employee.getSalary(),employee.getDname(),employee.getEname(),employee.getHiredate(),employee.getEno()
        });
        return count;
    }
